...
Scene.prototype.buildRectangularElement = function() {
	...
	this.floor = new THREE.Mesh(new THREE.PlaneBufferGeometry(this.width, this.depth), this.materialFloor);
	...
	this.wall = new THREE.Mesh(new THREE.PlaneBufferGeometry(this.width, this.height, 10, 10), this.materialWall);
	...
	this.wallfront = new THREE.Mesh(new THREE.PlaneBufferGeometry(this.width, this.height, 10, 10), this.materialWall);
	...
	this.wallLeft = new THREE.Mesh(new THREE.PlaneBufferGeometry(this.depth, this.height, 10, 10), this.materialWallLeft);
	...
	this.wallRight = new THREE.Mesh(new THREE.PlaneBufferGeometry(this.depth, this.height, 10, 10), this.materialWallRight);

	this.ceiling = new THREE.Mesh(new THREE.PlaneBufferGeometry(this.width, this.depth, 10, 10), this.materialCeiling);
