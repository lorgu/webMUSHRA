...
function LocalizationObject2(_objConfig) {
...
LocalizationObject2.prototype.init = function(_scene) { 
  _scene.add(this.mesh); 
};

LocalizationObject2.prototype.eventOnMouseUp = function(_event, _x, _y, _z) {    
};

LocalizationObject2.prototype.eventOnMouseDown = function(_event, _x, _y, _z) {  
  if (_x != null) {
...
LocalizationObject2.prototype.render = function() {  
};

LocalizationObject2.prototype.getCenterPosition = function() {
 ...
 */
LocalizationObject2.prototype.storeValues = function(_trial, _session, _trial_id) {  
  if (_trial === null) {
    _trial = new Trial();
