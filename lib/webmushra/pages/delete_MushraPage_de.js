...
function MushraPage_de(_pageManager, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _mushraValidator, _errorHandler, _language) {
	this.isMushra = true; 
...
MushraPage_de.prototype.getName = function () {
  return this.pageConfig.name;
};

MushraPage_de.prototype.init = function () {
   var toDisable;
  var td;
  var active; 
...
MushraPage_de.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  var content; 
...
MushraPage_de.prototype.pause = function() {
    this.mushraAudioControl.pause();
};

MushraPage_de.prototype.setLoopStart = function() {
...
MushraPage_de.prototype.setLoopEnd = function() {
  var slider = document.getElementById('slider'); 
...
MushraPage_de.prototype.btnCallbackReference = function() {
...
MushraPage_de.prototype.surpressLoop = function() {
...
MushraPage_de.prototype.btnCallbackCondition = function(_index) {
...
MushraPage_de.prototype.renderCanvas = function(_parentId) {
...
MushraPage_de.prototype.load = function () {
...
MushraPage_de.prototype.save = function () {
  this.macic.unbind(); 
...
MushraPage_de.prototype.store = function () {
