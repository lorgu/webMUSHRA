...
FinishPage.prototype.sendResults = function() {
  ...
  // this.pageConfig.email
  if (window.location.href === "http://localhost:8000/?config=interpolation_tmp.yaml") {
  // if (window.location.href === "http://localhost:8000/?config=interpolation_tmp.yaml&email=element.name") {
      window.location.href = "http://localhost:8000/?config=interpolation_tmp_page2.yaml";
  } else if (window.location.href === "http://localhost:8000/?config=interpolation_tmp_page2.yaml&email=element.name") {
    window.location.href = "http://localhost:8000/?config=interpolation_tmp_page3.yaml";
  }
};
